  ...
  <div className="container mx-auto w-full">
    <div className="flex w-full items-center justify-evenly pt-5">
      ...
      <div className="flex w-1/2 content-center justify-end">
        ...
        <a className="hover:text-underline inline-block h-10 transform p-2 text-center text-blue-300 no-underline duration-300 ease-in-out hover:scale-125 hover:text-pink-500 md:h-auto md:p-4" href="https://www.facebook.com/">
          <svg className="h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
...
//         <img src="https://cdn.dribbble.com/userupload/6894190/file/original-96afecc1619321404c356017c09b17ee.jpg?resize=752x" className="h-8 mr-3 rounded-3xl" alt="Flowbite Logo" />
//         <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">My Drive</span>
//     </a>
...
//         </li>
//         <li>
//           <a href="/home-page" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">User</a>
//         </li>
